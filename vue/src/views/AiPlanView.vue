...
const respList = JSON.parse(route.query.data);
const tripList = respList._value.contents;
...
const plan = ref({
  userId: userId,
  planName: "AI가 추천하는 여행코스",
  description: respList._value.description,
  routePlans: [],
});
